...
//Mostrar las intrucciones para responder 

document.write("<div class=\"container\">");
document.write("<div class=\"row\">");
document.write("<h1 class=\"text-center\">");
document.write("Encuestas para determinar cuantas personas esta a favor de la portabilidad numerica de telefonos ");
...
//en tanto no se de por determinada el ingreso de respuesta de la encuesta

while(opcion==true){
    voto= parseInt(prompt('¿Cual es su voto',''));
    switch(voto){
        case 1 :{
            cont1++;
            break;}
        ...
        case 3:{
            ...
            break }
         default:{
            alert('voto no valido');}         
    }
    //se pregunta si se desea continuar o terminar la encuesta o continuar 

    opcion = confirm('¿desea continuar s/n?');
}

//obtener el total de respuestas en la encuesta 
