...
function createform(control, numero){
    var htmlform,tag, i;
    //referenciar al elemento de la pagina web dode se 
    //mostrara el formulario creado 

    var formview = document.getElementById('view');
    htmlform = "<div class=\"row position-relative\">";
    htmlform += "<form name =\"miform\">\n";
    htmlform += '<h1 class="display-l text-center">Formulario dinamico</h1>';
    ...
    with(document){
        ...
        switch(control){
            ...
            case "button":
                ...
                break;
            default:
                alert("No ha seleccion el tipo de control");
                return;
                break;
